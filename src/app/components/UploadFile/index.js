  ...
  const handleFile = async (e) => {
    ...
    const response = await fetch(
      `https://happy-test2.herokuapp.com/api/upload/${cedula}`,
      {
        ...
        body: formData,
        headers: {
          Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJBZG1pbiIsImlhdCI6MTU3Mzg3MTUzNiwiZXhwIjoxNTc1MDgxMTM2fQ.IMdEhhmvy7IjPzXptNuNEzA1BynsjyI_HjfejAGnE9E",
        },
        mode: "cors"
      }
    );
