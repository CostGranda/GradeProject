            ...
            <div>
                <form onSubmit={this.updateRow}>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input ref={this.dateRef} type="date" className="form-control" id="inputSurname4" placeholder="Surnames" />
                    </div>
                    <div className="form-group col-md-6">
                        <label htmlFor="exampleFormControlTextarea2">Description</label>
                        <textarea ref={this.descriptionRef} class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3"></textarea>
                    </div>
